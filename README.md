...
The software and documentation are located in the repo [YaoGroup/ice_1D_pinn](https://github.com/YaoGroup/ice_1D_pinn/tree/main). A detailed description of the software can be found at this link. 
